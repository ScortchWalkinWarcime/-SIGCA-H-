...
<div class="header w3-display-container">
    <h5>Sistema de Gestión - Admin</h5>
...
const rol = "admin"; // Fixed for admin dashboard
const nombre = localStorage.getItem("usuario") || "Usuario";

// mostrar usuario
$("#user-info").text(`Usuario: ${nombre} (${rol})`);

// No need to hide anything for admin

// bloquear inputs if not admin - but since it's admin, no blocking
